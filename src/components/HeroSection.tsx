      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10 flex flex-col items-center text-center">
        ...
        <div className="space-y-6 w-full flex flex-col items-center">
          ...
          <div className="w-full max-w-3xl mx-auto mt-4">
            {/* Quality & Auto-Download Selector Bar */}
            <div className="flex flex-wrap items-center justify-between gap-2 px-2 pb-2">
              <div className="flex items-center gap-2">
                ...
                <div className="inline-flex p-1 rounded-xl bg-slate-200/80 border border-slate-300/70 text-xs font-medium">
                  <button
                    type="button"
              ...
              {setAutoDownload && (
                <button
                  ...
                  title="Automatically starts PDF download when scraping completes"
                >
                  <Zap className={`w-3.5 h-3.5 ${autoDownload ? "text-emerald-600 fill-emerald-500" : "text-slate-400"}`} />
                  <span>Auto-Download PDF:</span>
                  <span className={`px-1.5 py-0.2 rounded text-[10px] font-bold ${autoDownload ? "bg-emerald-600 text-white" : "bg-slate-300 text-slate-700"}`}>
                    {autoDownload ? "ON (Instant)" : "OFF"}
                  </span>
                </button>
              )}
            </div>
